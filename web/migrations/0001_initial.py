# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-01 08:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.GalaxyInstance')),
            ],
        ),
        migrations.CreateModel(
            name='JobParam',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tool', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Tool')),
            ],
            options={
                'ordering': ('-version',),
            },
        ...
        migrations.AddField(
            model_name='job',
            name='metrics',
            field=models.ManyToManyField(to='web.Metric'),
        ),
        migrations.AddField(
            model_name='job',
            name='params',
            field=models.ManyToManyField(to='web.JobParam'),
        ),
        migrations.AddField(
            model_name='job',
            name='tool',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.ToolVersion'),
        ),
        migrations.AddField(
            model_name='galaxyinstance',
            name='tools',
            field=models.ManyToManyField(blank=True, to='web.ToolVersion'),
        ),
