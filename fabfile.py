"""
Starter fabfile for deploying the grt project.
...
# CHANGEME
env.hosts = ['user@grt.example.com']
env.code_dir = '/srv/www/grt'
env.project_dir = '/srv/www/grt/grt'
env.static_root = '/srv/www/grt/static/'
env.virtualenv = '/srv/www/grt/.virtualenv'
env.code_repo = 'git@github.com:user/grt.git'
env.django_settings_module = 'grt.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/grt/wsgi.py" % env.code_dir)
